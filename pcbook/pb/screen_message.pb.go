...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=demo_go.pcbook.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x28, 0x0b, 0x32, 0x21, 0x2e, 0x64, 0x65, 0x6d, 0x6f, 0x5f, 0x67, 0x6f, 0x2e, 0x70, 0x63, 0x62,
	...
	0x32, 0x1c, 0x2e, 0x64, 0x65, 0x6d, 0x6f, 0x5f, 0x67, 0x6f, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: demo_go.pcbook.Screen.Panel
	(*Screen)(nil),            // 1: demo_go.pcbook.Screen
	(*Screen_Resolution)(nil), // 2: demo_go.pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: demo_go.pcbook.Screen.resolution:type_name -> demo_go.pcbook.Screen.Resolution
	0, // 1: demo_go.pcbook.Screen.panel:type_name -> demo_go.pcbook.Screen.Panel
