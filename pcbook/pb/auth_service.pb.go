...
var file_auth_service_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0e, 0x64, 0x65, 0x6d, 0x6f, 0x5f, 0x67, 0x6f, 0x2e, 0x70, 0x63,
	0x62, 0x6f, 0x6f, 0x6b, 0x22, 0x46, 0x0a, 0x0c, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x71,
	...
	0x46, 0x0a, 0x05, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x1c, 0x2e, 0x64, 0x65, 0x6d, 0x6f, 0x5f,
	0x67, 0x6f, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1d, 0x2e, 0x64, 0x65, 0x6d, 0x6f, 0x5f, 0x67, 0x6f,
	0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x73,
...
var file_auth_service_proto_goTypes = []interface{}{
	(*LoginRequest)(nil),  // 0: demo_go.pcbook.LoginRequest
	(*LoginResponse)(nil), // 1: demo_go.pcbook.LoginResponse
}
var file_auth_service_proto_depIdxs = []int32{
	0, // 0: demo_go.pcbook.AuthService.Login:input_type -> demo_go.pcbook.LoginRequest
	1, // 1: demo_go.pcbook.AuthService.Login:output_type -> demo_go.pcbook.LoginResponse
...
func (c *authServiceClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/demo_go.pcbook.AuthService/Login", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AuthService_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/demo_go.pcbook.AuthService/Login",
	}
...
var _AuthService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "demo_go.pcbook.AuthService",
