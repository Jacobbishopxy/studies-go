...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=demo_go.pcbook.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1b, 0x2e, 0x64, 0x65, 0x6d, 0x6f, 0x5f, 0x67, 0x6f, 0x2e,
	...
	0x47, 0x49, 0x47, 0x61, 0x42, 0x59, 0x54, 0x45, 0x10, 0x05, 0x12, 0x0c, 0x0a, 0x08, 0x54, 0x45,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: demo_go.pcbook.Memory.Unit
	(*Memory)(nil),   // 1: demo_go.pcbook.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: demo_go.pcbook.Memory.unit:type_name -> demo_go.pcbook.Memory.Unit
